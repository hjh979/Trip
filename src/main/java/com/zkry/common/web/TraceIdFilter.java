...
public class TraceIdFilter extends OncePerRequestFilter {
    ...
    private void logRequest(
        ...
        // 高德代理查询参数包含 Web JS Key；代理路径只记录 URI，不记录任何查询参数。
        String uri = request.getRequestURI().startsWith("/_AMapService")
            ? request.getRequestURI()
            : request.getRequestURI() + (StringUtils.hasText(query) ? "?" + query : "");
